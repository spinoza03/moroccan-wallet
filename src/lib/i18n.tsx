...
const translations: Record<string, Record<Language, string>> = {
  ...
  'sub.trial': { fr: "Commencer 3h d'essai gratuit", darija: 'بدا تجربة 3 سوايع فابور' },
  'sub.trialStarted': { fr: 'Essai de 3h commencé !', darija: 'بدات تجربة 3 سوايع!' },
  'sub.trialEndedTitle': { fr: 'Période d\'essai terminée', darija: 'سالات فترة التجربة' },
  'sub.trialEndedDesc': { fr: 'Veuillez choisir un abonnement pour continuer à profiter de l\'application.', darija: 'عافاك اختار اشتراك باش تكمل فتطبيق ميزانيتي.' },
